        ...
        <section style={{
            ...
            <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', padding: '0 2rem' }}>
                <p style={{
                    ...
                    color: 'var(--accent)', letterSpacing: '0.3em', textTransform: 'uppercase',
                ...
                <h1 style={{
                    ...
                    <span style={{ display: 'block', color: 'var(--text)' }}>Alain Patrick</span>
                    <span style={{
                        display: 'block',
            ...
            <div style={{
                ...
                <span style={{ fontFamily: "'Space Mono', monospace", fontSize: '0.7rem', color: 'var(--text-muted)', letterSpacing: '0.2em' }}>SCROLL</span>
