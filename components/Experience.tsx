export default function Experience() {
    return (
      ...
      `}</style>
            ...
            <section id="experience" style={{ padding: 'clamp(4rem, 10vw, 8rem) 1.5rem' }}>
                <div style={{ maxWidth: 1100, margin: '0 auto' }}>
                    ...
                    <h2 style={{ fontSize: 'clamp(1.6rem, 3vw, 2.5rem)', fontWeight: 800, marginBottom: '4rem' }}>
                        Where I've worked
                    </h2>
                    ...
                    <div style={{ position: 'relative', paddingLeft: '2rem' }}>
                        ...
                        <div style={{ position: 'relative', marginBottom: '4rem' }}>
                            ...
                            <div className="exp-header">
                                ...
                                <span style={{ fontFamily: "'Space Mono', monospace", fontSize: '0.72rem', color: 'var(--text-muted)' }}>Internship</span>
                            </div>
                            <h3 style={{ fontSize: 'clamp(1.1rem, 2.5vw, 1.3rem)', fontWeight: 700, marginBottom: '0.3rem' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            <div className="exp-header">
                                ...
                                <span style={{ fontFamily: "'Space Mono', monospace", fontSize: '0.72rem', color: 'var(--text-muted)' }}>Education</span>
                            </div>
                            <h3 style={{ fontSize: 'clamp(1.1rem, 2.5vw, 1.3rem)', fontWeight: 700, marginBottom: '0.3rem' }}>
